...
//
//	Shader ourShader("v3shader_model.glsl", "f3shader_model.glsl");
//	Shader ourShader1("v3shader_model.glsl", "f3shader_model2.glsl");
//
//	Shader lampShader("v3shader_light.glsl", "f3shader_light.glsl");
